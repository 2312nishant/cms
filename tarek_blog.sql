...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2017 at 05:26 PM
...
(2, 'editor-arabic', 'Editor for Arabic Articles'),
(3, 'editor-english', 'Editor for English + Arabic Articles');
...
(1, 'email_contact', 'san23.patil@gmail.com', 'Email kontak form'),
...
(6, 'pagination_limit', '2', 'Batas list /record (artikel, file, dll) per halaman'),
(7, 'main_office', 'Company Address', ''),
(8, 'site_title', 'Articles CMS ', ''),
(18, 'pagination_limit_directory', '2', '');
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1510501517, 1, 'Admin', 'istrator', 'ADMIN', '0'),
(9, '127.0.0.1', 'members', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', NULL, 'members@website.com', '', NULL, NULL, NULL, 1451071829, 1510497299, 1, 'Team 1 editor', '', '', '');
