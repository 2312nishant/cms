            ...
            <form role="form" action="<?php echo site_url('admin/posts/add')?>" method="post">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <?php
                            echo form_dropdown('language',$post_language,set_value('language'),array('class' => 'form-control'));
                        ?>
                    </div>
                    <?php endif;?>
                      <?php if($this->ion_auth->in_group(array('editor-arabic'))):?>
                    <div class="form-group">
                        <label for="post_language">Language</label>
                        <?php
                            echo form_dropdown('language',$post_ar_language,set_value('language'),array('class' => 'form-control'));
                        ?>
                    </div>
                    <?php endif;?>
                    <div class="form-group">
